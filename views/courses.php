  ...
  <main>
    <div class="container">
      <div style="text-align:end">
        <a class="nav-link active" aria-current="page" href="../index.php"><i class="fa fa-reply" aria-hidden="true"></i>Atras</a>
      </div>
      <div>
        <hr>
        <h2 class="d-block bg-info text-white font-italic p-2 " style="text-align:center;">Conociendo Gmail</h2>
      </div>  
      <hr>
      <div class="row">
        <div class="col-md-12">
          <main>
            <section>
                ...
                <div class="card m-2 p-3">
                  ...
                  <div id="" role="tabpane1" class="">
                    <div class="card-block">
                      <a href="../views/moduloUno/conociendoGmail.php"><i class="fa fa-youtube-square" aria-hidden="true"></i>VIDEO: conociendo gmail</a>
                    </div>
                    <div class="card-block">
                      <a href="../views/moduloUno/entornoGmail.php"><i class="fa fa-book" aria-hidden="true"></i>CONTENIDO: Diapositivas entorno Gmail</a>
                    </div>
                    <div class="card-block">
                      <a href="../views/moduloUno/cuestionaryone.php"><i class="fa fa-question-circle" aria-hidden="true"></i>CUESTIONARIO: Modulo 1 Conceptos generales de gmail</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card m-2 p-3">
                ...
                <div id="" role="tabpane1" class="">
                  <div class="card-block">
                    <a href="../views/moduloDos/contenidoVideo.php"><i class="fa fa-youtube-square" aria-hidden="true"></i>CONTENIDO: Video interactivo tu cuenta gmail</a>
                  </div>
                  <div class="card-block">
                    <a href="../views/moduloDos/cuentaGmail.php"><i class="fa fa-book" aria-hidden="true"></i>CONTENIDO: diapositivas paso a paso crear tu cuenta gmail</a>
                  </div>
                  <div class="card-block">
                    <a href="../views/moduloDos/cuestionarytwo.php"><i class="fa fa-question-circle" aria-hidden="true"></i>CUESTIONARIO: Como crear tu cuenta gmail</a>
                  </div>
                </div>
              </div>
