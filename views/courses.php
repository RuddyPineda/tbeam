  ...
  <div class="container">
    ...
    <div id="accordion" role="tablist" aria-multiselectable="true">
      ...
      <div class="card m-2 p-3">
        ...
        <div id="" role="tabpane1" class="">
          <div class="card-block">
            <a href="../views/moduloDos/cuentaGmail.php">CONTENIDO: diapositivas paso a paso crear tu cuenta gmail</a>
            <hr>
            <a href="../views/moduloDos/contenidoVideo.php">CONTENIDO: Video interactivo tu cuenta gmail</a>
            <hr>
      ...
      <div class="card m-2 p-3">
        ...
        <div id="" role="tabpane1" class="">
          <div class="card-block">
            <a href="../views/moduloUno/cuestionaryone.php">CUESTIONARIO: Modulo 1 Conceptos generales de gmail</a>
            <hr>
            <a href="../views/moduloDos/cuestionarytwo.php">CUESTIONARIO: Modulo 2 Como crear tu cuenta gmail</a>
            <hr>
