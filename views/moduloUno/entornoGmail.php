...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div>
                <hr>
                <h2 class="d-block bg-info text-white font-italic p-2 " style="text-align:center; background:#28a745 !important">MODULO 1: Diapositivas entorno Gmail</h2>
            </div>
            <hr>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="ratio ratio-16x9">
                                                <iframe class="diapositiva" src="https://www.youtube.com/embed/A3PDXmYoF5U" title="YouTube video" allowfullscreen></iframe>
                                            </div>
