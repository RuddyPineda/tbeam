...
<body >
    ...
    <div class="container">
  <head>
    <h1 class=" m-3 p-2 d-block text-info font-italic">video interactivo tu cuenta gmail.</h1> <hr>
    <p>Lecciones:</p>
  ...
  <section>
    ...
    <div id="contenidogmail">
         ...
         <h3 class=" d-block bg-ligth text-black">VIDEO INTERACTIVO ASPECTOS DE GMAIL</h3> <hr>
    ...
    <div class="card m-2 p-3">
          <div class="card-header" role="tab">
             <h5>
             <a href="#"  class="text-info" data-toggle="collapse" data-parent="#accordion" aria-expanded="true">videointeractivotucuentagmail.youtube </a>
             </h5>
          </div>
