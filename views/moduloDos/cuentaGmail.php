                                    ...
                                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                        <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                                            <a href="#" data-target="#exampleModal1" data-toggle="modal">
                                                <img src="../../assets/img/cuentaGmail.jpg" class="w-100 h-150" />
                                    ...
                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                                            <a href="#" data-toggle="modal" data-target="#exampleModal2">
                                                <img src="../../assets/img/secuenta.jpg" class="heigth 100px w-100 " />
                                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                                            <a href="#" data-target="#exampleModal3" data-toggle="modal">
                                                <img src="../../assets/img/final.jpg" class="w-100 h-100px" />
                                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <section class="">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="ratio ratio-16x9">
                                                 <img class="diapositiva" src="../../assets/img/cuentaGmail.jpg" alt="">
                                            </div>
                                ...
                                <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModal2Label" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="ratio ratio-16x9">
                                                <img class="diapositiva" src="../../assets/img/secuenta.jpg" alt="">
                                            </div>
                                ...
                                <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModal3Label" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="ratio ratio-16x9">
                                                <img class="diapositiva" src="../../assets/img/final.jpg" alt="">
                                            </div>
